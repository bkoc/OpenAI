...
final public class OpenAI: OpenAIProtocol {
    ...
    public struct Configuration {
        ...
        public init(token: String, organizationIdentifier: String? = nil, host: String = "api.openai.com", port: Int = 443, scheme: String = "https", timeoutInterval: TimeInterval = 60.0, versionPath: String = "/v1") {
            self.token = token
...
extension OpenAI {
    ...
    func buildURL(path: String) -> URL {
        ...
        let versionPath = configuration.versionPath + path
